export const translations = {
  en: {
    ...
    home: {
      ...
      quote: {
        text: 'The dua of a Muslim for his brother in his absence is readily accepted. An angel is appointed at his side. When he makes a dua for his brother the angel says, "Ameen, and the same for you too."',
        source: 'Sahih Muslim'
      }
    },
    duas: {
      title: 'Duas Library',
      subtitle: 'Browse our collection of authentic duas for every occasion',
      search: 'Search Duas',
    ...
    requests: {
      title: 'Dua Requests',
      subtitle: 'Share your prayer requests with the community',
      loading: 'Loading requests...',
      noRequests: 'No requests found',
      tryAgain: 'Try Again',
      browseRequests: 'Browse Requests',
      createRequest: 'Create Request',
      shareRequest: 'Share Your Request',
      shareDescription: 'Share your dua request with the community. Others will make dua for you.',
      placeholder: 'Enter your dua request here...',
      submit: 'Submit Request',
      thankYouTitle: 'Thank You',
      thankYouDescription: 'Your dua has been recorded. May Allah accept it.',
      errorTitle: 'Error',
      errorDescription: 'Failed to record your dua. Please try again.',
      today: 'Today',
      yesterday: 'Yesterday',
      daysAgo: '{{count}} days ago',
      madeDua: 'You Made Dua',
      iMadeDua: 'I Made Dua',
      personMadeDua: 'person made dua',
      peopleMadeDua: 'people made dua'
    },
    category: {
      all: 'All',
      general: 'General',
  ...
  tr: {
    ...
    duas: {
      ...
      subtitle: 'Her durum için otantik dualar koleksiyonumuza göz atın',
      search: 'Dua Ara',
    ...
    requests: {
      title: 'Dua İstekleri',
      subtitle: 'Dua isteklerinizi toplulukla paylaşın',
      loading: 'İstekler yükleniyor...',
      noRequests: 'İstek bulunamadı',
      tryAgain: 'Tekrar Dene',
      browseRequests: 'İsteklere Göz At',
      createRequest: 'İstek Oluştur',
      shareRequest: 'İsteğinizi Paylaşın',
      shareDescription: 'Dua isteğinizi toplulukla paylaşın. Diğerleri sizin için dua edecek.',
      placeholder: 'Dua isteğinizi buraya girin...',
      submit: 'İsteği Gönder',
      thankYouTitle: 'Teşekkürler',
      thankYouDescription: 'Duanız kaydedildi. Allah kabul etsin.',
      errorTitle: 'Hata',
      errorDescription: 'Duanız kaydedilemedi. Lütfen tekrar deneyin.',
      today: 'Bugün',
      yesterday: 'Dün',
      daysAgo: '{{count}} gün önce',
      madeDua: 'Dua Ettiniz',
      iMadeDua: 'Dua Ediyorum',
      personMadeDua: 'kişi dua etti',
      peopleMadeDua: 'kişi dua etti'
    },
    category: {
      all: 'Tümü',
      general: 'Genel',
  ...
  de: {
    ...
    duas: {
      ...
      subtitle: 'Durchsuchen Sie unsere Sammlung authentischer Bittgebete für jeden Anlass',
      search: 'Bittgebete suchen',
    ...
    requests: {
      ...
      subtitle: 'Teilen Sie Ihre Gebetsanliegen mit der Gemeinschaft',
      ...
      shareRequest: 'Teilen Sie Ihre Anfrage',
      shareDescription: 'Teilen Sie Ihr Gebetsanliegen mit der Gemeinschaft. Andere werden für Sie beten.',
      placeholder: 'Geben Sie hier Ihr Gebetsanliegen ein...',
      submit: 'Anfrage einreichen',
      thankYouTitle: 'Vielen Dank',
      thankYouDescription: 'Ihr Gebet wurde aufgezeichnet. Möge Allah es annehmen.',
      errorTitle: 'Fehler',
      errorDescription: 'Ihr Gebet konnte nicht aufgezeichnet werden. Bitte versuchen Sie es erneut.',
      today: 'Heute',
      yesterday: 'Gestern',
      daysAgo: 'vor {{count}} Tagen',
      madeDua: 'Sie haben gebetet',
      iMadeDua: 'Ich habe gebetet',
      personMadeDua: 'Person hat gebetet',
      peopleMadeDua: 'Personen haben gebetet'
    },
    category: {
      all: 'Alle',
      general: 'Allgemein',
